...
export function ProblemSolution() {
    return (
        <section className="bg-surface-sunken py-24 px-6 sm:py-32 relative z-0" id="notebook-objection">
            <div className="mx-auto max-w-5xl">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:gap-12 relative">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="flex flex-col rounded-[2.5rem] border border-red-100/50 bg-white/60 backdrop-blur-xl p-8 sm:p-10 shadow-xl shadow-red-900/5"
                    >
                        <div className="mb-8 flex h-14 w-14 items-center justify-center rounded-2xl bg-red-50 text-red-500 shadow-sm border border-red-100">
                            <BookX className="h-7 w-7" />
                        </div>
                        <h3 className="mb-5 text-2xl font-bold text-red-950">The Notebook Way</h3>
                        <ul className="mb-10 space-y-4 text-text-secondary font-medium">
                            <li className="flex items-start">
                                <span className="mr-4 text-red-400 mt-1">❌</span>
                        ...
                        <div className="mt-auto border-t border-red-100/50 pt-6">
                            <p className="font-semibold text-red-950">
                                Result: <span className="text-red-500">Lost continuity. Lost revenue.</span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <div className="mb-8 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-500 text-white shadow-md shadow-brand-500/20">
                                <BotMessageSquare className="h-7 w-7" />
                            </div>
                            <h3 className="mb-5 text-2xl font-bold text-brand-950">The Ruthva Way</h3>
                            <ul className="mb-10 space-y-4 text-text-secondary font-medium">
                                <li className="flex items-start">
                                    <span className="mr-4 text-brand-500 mt-1">✅</span>
